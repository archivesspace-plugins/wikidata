# Adds 'wikidata' as a value of the name_source enumeration so that agents
# imported from Wikidata are attributed to Wikidata as their source (rather
# than the generic 'local' source). name_source backs both
